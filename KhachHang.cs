...
namespace QLKS
{
    public partial class KhachHang : Form
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("DSKhachHang", TruyXuatCSDL.taoketnoi());
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("ThemKH", TruyXuatCSDL.taoketnoi());
            cmd.CommandType = CommandType.StoredProcedure;
            if (kiemtra())
            {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("SuaKH", TruyXuatCSDL.taoketnoi());
            if (kiemtra())
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@makh", txtMkh.Text);
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            if (gvKhachhang.SelectedRows.Count > 0)
            {
                ...
                SqlCommand cmd = new SqlCommand("XoaKH", TruyXuatCSDL.taoketnoi());
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmd = new SqlCommand("TimKHTen", TruyXuatCSDL.taoketnoi());
            cmd.CommandType = CommandType.StoredProcedure;
