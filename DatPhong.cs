...
namespace QLKS
{
    public partial class DatPhong : Form
    {
        ...
        public ThuePhong frmTP;
        public KhachHang frmKH;
        public nMain fMain;
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT makh, tenkh FROM [tblkhachhang]", TruyXuatCSDL.taoketnoi());
            dataset = new DataSet();
        ...
        {
            SqlCommand cmd = new SqlCommand("DSPhieudatPhong", TruyXuatCSDL.taoketnoi());
        ...
        {
            SqlCommand cmd = new SqlCommand("TimPhongTrong", TruyXuatCSDL.taoketnoi());
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void cbkh_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("TimKH", TruyXuatCSDL.taoketnoi());
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmd = new SqlCommand("DatPhong", TruyXuatCSDL.taoketnoi());
            cmd.CommandType = CommandType.StoredProcedure;
            if (txtmapd.Text != "" && txtSonguoi.Text != "")
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < gvTimPhong.SelectedRows.Count; i++)
                    {
                        ...
                        SqlCommand cmd2 = new SqlCommand("CTDatPhong", TruyXuatCSDL.taoketnoi());
                        ...
                        SqlCommand cmd3 = new SqlCommand("UpdateDatPhong", TruyXuatCSDL.taoketnoi());
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (gvDatPhong.SelectedRows.Count > 0)
            {
                ...
                SqlCommand cmd1 = new SqlCommand("TimPhongN", TruyXuatCSDL.taoketnoi());
                ...
                SqlCommand cmd = new SqlCommand("NhanPhong", TruyXuatCSDL.taoketnoi());
                cmd.CommandType = CommandType.StoredProcedure;
